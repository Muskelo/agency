  ...
  <div class="wrapper">
    <div class="container">
      ...
      <ul class="grid list-unstyled py-3">
        <!-- item -->
        <li class="g-col-12 g-col-xl-3" v-for="item in items" :key="item.id">
          <div class="card">
            <div class="card-img-top ratio ratio-16x9 overflow-hidden">
              <img :src="item.images[0].url" alt="...">
            </div>
            <div class="card-body">
              <h5 class="card-title">{{item.rooms}}-комн., {{item.size}}м<sup>2</sup>, {{item.floor}}/{{item.floor_total}} этаж</h5>
